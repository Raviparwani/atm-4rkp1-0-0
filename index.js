    ...
    if (pinAnswer.pin === myPin) {
        ...
        if (operationAns.operation === "withdraw") {
            ...
            if (amountAns.amount > "50000") {
                console.log(chalk.red.bold("Sorry, but you've reached the daily withdrawal limit of 20,000. Further withdrawals are currently not possible."));
            }
            else if (amountAns.amount > myBalance) {
                console.log(chalk.red.bold("Insufficient funds, Yoy can't withdraw more then your current balance "));
            }
            else {
                myBalance -= amountAns.amount;
                console.log(chalk.hex("cc00cc").bold("Your remaining balance is >-----> ") +
                    chalk.red.bold(myBalance));
            }
        }
        else if (operationAns.operation === "check balance") {
            console.log(chalk.blue.bold("Your Balance is >-----> ") + chalk.cyan.bold(myBalance));
            ...
            if (parseInt(fastCashAmount.amount) > myBalance) {
                console.log(chalk.red.bold("Insufficient funds, You can not withdraw more then your current balance "));
            }
            else {
                myBalance -= parseInt(fastCashAmount.amount);
                console.log(chalk.yellow.bold("Your remaining balance is >-----> ") +
            ...
            console.log(chalk.green.bold.hex("ff8000")("Deposit successful. Your new balance is >-----> ") +
            ...
            if (epAns.amount > "50000") {
                console.log(chalk.red.bold("Sorry, but you've reached the daily sending limit of 50,000. Further sendigs are currently not possible."));
            }
            else if (epAns.amount > myBalance) {
                console.log(chalk.red.bold("Insufficient funds, Yoy can't send more then your current balance "));
            }
            else {
